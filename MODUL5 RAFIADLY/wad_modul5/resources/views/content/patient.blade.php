...
<body>
    ...
    <div class="text-center">
        ...
        <div class="card-body">
            <a href="{{ route('takeVaccine')}}" class="btn btn-primary">Add Patient</a>
        </div>
    </div>
    ...
    {{ $i = 0 }}
    <h1 class="text-center">List Patient</h1>
    <div class="container d-flex">
        <a href="{{route('takeVaccine')}}" class="btn btn-dark">Register Patient</a>
    </div>
    <br>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('deletePatient', ['id' => $patient->id]) }}">
