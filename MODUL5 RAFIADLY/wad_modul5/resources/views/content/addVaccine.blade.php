...
<body>
    ...
    <main class="container shadow d-flex flex-column p-5 mt-1">
        <div class="display-6 text-center"><b>Input Vaccine</b></div>
        <div class="container">
            <form method="POST" action="{{ route('addVaccine') }}" enctype="multipart/form-data">
                @csrf
                ...
                <textarea name="description" id="deskripsi" cols="30" rows="5" class="form-control"></textarea>
